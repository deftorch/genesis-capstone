...
const MatterCanvas: React.FC<MatterCanvasProps> = ({ code, width = 400, height = 400, onError }) => {
...
<body>
  ...
  <script>
    ...
    try {
      // User's Matter.js code
      // We provide #matter-container as the mount point
      ${code}
    } catch(e) {
