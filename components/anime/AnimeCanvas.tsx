...
const AnimeCanvas: React.FC<AnimeCanvasProps> = ({ code, width = 400, height = 400, onError }) => {
...
<body>
  ...
  <script>
    ...
    try {
      // User's Anime.js code
      // We provide #anime-container as the mount point
      ${code}
    } catch(e) {
